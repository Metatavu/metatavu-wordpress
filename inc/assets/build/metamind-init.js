(()=>{'use strict';$(document).ready(()=>{console.log('asd');const element=$('.metamind-bot-container');const styleSheetUri=metamindwp.styleSheetUri;element.append(`
    ...
    `)})})();
//# sourceMappingURL=metamind-init.js.map
